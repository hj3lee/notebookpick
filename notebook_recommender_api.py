...
def recommend(user_input):
    ...
    else: df = df[(df["price_current"] >= user_input["budget_min"] * 0.9) & (df["price_current"] <= user_input["budget_max"] * 1.1)]
    ...
    return df.sort_values("overall_score", ascending=False).head(15)
